...
Page({
  ...
  onSearch() {
    ...
    wx.navigateTo({
      url: `/package-plant/pages/search_result/search_result?search_text=${encodeURIComponent(keyword)}&scientific_name=${encodeURIComponent(scientificName)}`
    });
  },
  ...
  selectSuggest(e) {
    ...
    this.saveHistory(keyword);
    wx.navigateTo({
      url: `/package-plant/pages/search_result/search_result?search_text=${encodeURIComponent(keyword)}`
    });
  },
  ...
  searchPlant(e) {
    ...
    wx.navigateTo({
      url: '/package-plant/pages/search_result/search_result?search_text=' + encodeURIComponent(text) + '&scientific_name=' + encodeURIComponent(scientificName)
    });
  },
  ...
  selectCategory(e) {
    ...
    // 分类跳转到分类列表页
    wx.navigateTo({
      url: '/package-plant/pages/category_list/category_list?category=' + encodeURIComponent(category)
    });
  },
